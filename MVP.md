...
- How many built-in scenarios for MVP? (Suggest 3-4 covering different domains)
- Should debrief be generated by LLM or computed from stored feedback?
- Linear conversation only for MVP (no branching) - confirm this simplification?
